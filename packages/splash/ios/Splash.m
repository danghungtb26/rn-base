...
RCT_EXPORT_METHOD(show:(float)duration) {
  ...
  [Splash setAnimationForWindow:[[_presentedViewController view] window]
                             duration:duration
...
RCT_EXPORT_METHOD(hide:(float)duration) {
  ...
  [Splash setAnimationForWindow:[[_splashViewController view] window]
                             duration:duration
